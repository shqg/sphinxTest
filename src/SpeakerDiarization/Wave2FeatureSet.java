...
import fr.lium.spkDiarization.tools.ConcatFeatureSet;
...
public class Wave2FeatureSet {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			//args=new String[] {"--fInputMask=/Users/labcontenuti/Music/DeAndre-DonRaffae.wav  --doCEClustering  showName=/Users/labcontenuti/Music/DeAndre-DonRaffae.wav"};
			args=new String[] {"D:\real-time meetingrecord.wav"};
